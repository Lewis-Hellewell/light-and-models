...
static void makeMenu(); // Task J.a - stops error at compilation
...
static void addObject(int id) {
    ...
    makeMenu(); // Task J.a - remakes menu
}

// Task J.b - Object Duplication
...
static void deleteObject(int id) { 
    ...
    makeMenu(); // remakes menu for conditional
}
...
void init(void) {
    ...
    // TASK I.a - Adding a directional light
...
void drawMesh(SceneObject sceneObj) {
    ...
    // Task B - Object Rotation (negating rotation on x access to replicate sample video)
...
void display(void) {
    ...
    // Task A - Camera Rotation (sets the view matrix and rotation)
    ...
    // Task I.b - Directional only affected by camera rotation
    SceneObject lightObj2 = sceneObjs[2];
    vec4 lightPosition2 = rotate * lightObj2.loc;

    // Task I.e - Seperated rgb calculations for the two light objects
    ...
    // Task H. Shine requires brightness to be passed
    ...
    for (int i = 0; i < nObjects; i++) {
        ...
        vec3 rgb = so.rgb * so.brightness * 2.0; // Modified to add second light
...
static void makeMenu() {
    ...
    if (nObjects > 3)   {
        glutAddMenuEntry("Duplicate Object", 51); // Task J.b - duplicate object menu entry
        glutAddMenuEntry("Delete Object", 52); // Task J.a - delete object menu entry
    }
